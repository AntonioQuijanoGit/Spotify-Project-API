...
import { GenreNotes } from "./GenreNotes";
        ...
        <div className="modal-content">
          ...
          <header className="modal-header">
            <div className="modal-header-content">
              <div
                className="genre-accent-bar"
                style={{ backgroundColor: genre.color }}
              />
              <div>
                <span className="genre-detail-category">{genre.category}</span>
                <h2 id="genre-title" className="genre-detail-title">
                  {genre.name}
                </h2>
                {genre.originYear && (
                  <p className="genre-detail-origin">
                    Originated in the {genre.originYear}
                  </p>
                )}
              </div>
              <ShareButton
          ...
          <div className="modal-body">
            ...
            <section className="detail-section">
              ...
              <p id="genre-description" className="genre-detail-description">
                {genre.description}
              </p>
            </section>
            ...
            {/* Personal Tags */}
            <section className="detail-section">
              <h3 className="section-heading">Personal Tags</h3>
              <GenreTags genreId={genre.id} />
            </section>

            {/* Personal Notes */}
            <section className="detail-section">
              <GenreNotes genreId={genre.id} />
            </section>
